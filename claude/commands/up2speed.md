Review the recent commit messages in the current branch to get up to speed on what we were working on.
...
Take into account not staged/not committed changes.
